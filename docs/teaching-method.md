...
标题也要直接写出本节结论或动作。“Qwen3.5 的边界”“它在交换什么”这类标题离开上下文就不知道在讲什么，应改成“FlashAttention 只作用于 Full Attention 层”“更大 Batch 会怎样影响吞吐和等待”。

标题应告诉读者这一段在讲哪个对象或动作，例如“Softmax 把分数变成权重”。只有正文确实围绕一个待回答的问题展开时，才使用问句标题。不要把每个小节都写成“为什么”“如何”或“是什么”，也不要用“让我们深入了解”“值得注意的是”“这不仅仅是”等开场句代替具体内容。
