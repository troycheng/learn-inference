...
读完第 9 课后，可以继续看[长上下文扩容评审](docs/capstone.md)。这个案例从目标上下文长度出发，算到 TP 下的每 Rank KV 容量，再比较 FP8 KV、Chunked Prefill、Prefix Cache 和增加 TP 分别能解决什么问题。它是一份完整示例，不要求读者填写模板。
